...
export default function GroupO() {
  const [groupBUsers, setGroupBUsers] = useState<any>([]);
  useEffect(() => {
    const fetchData = () => {
      fbGet('donor').then((users: any) => {
  ...
  return (
    <div>
      ...
      <Typography sx={{ fontSize: "30px", textAlign: "center", marginTop: 10 }} >Group O is a universal group </Typography>
