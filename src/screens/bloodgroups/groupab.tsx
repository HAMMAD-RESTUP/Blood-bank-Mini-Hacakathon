...
export default function GroupAB() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const users = await fbGetp('donor', 'Blood AB');
  ...
  return (
    <div>
      ...
      <Typography sx={{fontSize:"30px",textAlign:"center", marginTop: 10}} >Group AB Blood Donate Members</Typography>
